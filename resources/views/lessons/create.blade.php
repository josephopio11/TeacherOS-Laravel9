                                ...
                                <div class="col-lg-6">
                                    <div class="card-style mb-30">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floating-input" name="topic"
                                                    autocomplete="off">
                                                <label for="floating-input">Please enter the topic here</label>
                                            </div>
                                            ...
                                            <div class="col">
                                                <select class="form-select" name="scheme">
                                                    ...
                                                    @foreach ($options as $option)
                                                        <option value="{{ $option->mark }}">{{ $option->description }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="comment" rows="6" placeholder="Comment" id="editor"
                                                spellcheck="false">Oh! Come and see the violence inherent in the system! Help, help, I'm being repressed! We shall say 'Ni' again to you, if you do not appease us. I'm not a witch. I'm not a witch. Camelot!</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
